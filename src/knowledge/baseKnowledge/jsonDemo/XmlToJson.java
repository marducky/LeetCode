 ...
 * javaInherit.lang.NoClassDefFoundError: org/apache/commons/beanutils/DynaBean
 * commons-collections.jar 不加这个包
 * javaInherit.lang.NoClassDefFoundError: org/apache/commons/collections/map/ListOrderedMap
 * commons-lang-2.4.jar不加这个包
 * javaInherit.lang.NoClassDefFoundError: org/apache/commons/lang/exception/NestableRuntimeException
 * commons-logging-1.1.1.jar不加这个包
 * javaInherit.lang.NoClassDefFoundError: org/apache/commons/logging/LogFactory
 * ezmorph-1.0.6.jar不加这个包
 * javaInherit.lang.NoClassDefFoundError: net/sf/ezmorph/Morpher
 * json-lib-2.4-jdk15.jar不加这个包
 * javaInherit.lang.NoClassDefFoundError: net/sf/json/JSONObject
