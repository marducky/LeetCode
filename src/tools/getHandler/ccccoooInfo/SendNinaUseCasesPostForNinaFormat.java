...
public class SendNinaUseCasesPostForNinaFormat {
    /**
     * @param pathName
     * @return
     */
...
//                    System.out.print("");
    ...
    private String changeStubbyDemoJson() {
...
//        String iidPattern="\"@IID\" :\"[\\s\\S]*\"";
        ...
        String jsonObjectForPostJsonForStubby = changeStubbyDemoJson();
...
//                            String perJsonName = sssTemop.replace("*", "_").replace(":", "_").replace("?", "_");
                            ...
                            String jsonObjectForSave = jsonObjectForPostJsonForStubby.replace("text_flag", sssTemop);
                            String saveToFileYamlDemo = stubbyYamlDemoForNinaString.replace("request_json_flag", jsonObjectForSave).replace("response_json_flag", perJsonName);
                            stringBufferListForFinalTestToQA.append(jsonObjectForPostJsonForStubby.replace("text_flag", sssTemop) + "\n");
                            ...
                            try {
                                if (!fileJson.exists()) {
                                    ...
                                    fileJson = new File(pathName.substring(0, pathName.lastIndexOf('\\') + 1) + "json\\" + sssTemop.replace("*", "_").replace(":", "_").replace("?", "_") + Math.abs(random.nextInt()) % 100 + ".json");
                                }
    ...
    public static void main(String[] args) {
        SendNinaUseCasesPostForNinaFormat sendNinaUseCasesPostForNina = new SendNinaUseCasesPostForNinaFormat();
