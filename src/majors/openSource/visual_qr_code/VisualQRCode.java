...
public class VisualQRCode {
     ...
     * 创建视觉二维码
     *
     * @param content                         二维码内容、网址，必需
     * @param bgPath                          背景图片路径，必需
     * @param outPath                         二维码输出路径，必需
     * @param Level                           二维码容错等级，必需
     * @param DF                              颜色，必需
     * @param startX                          二维码X轴起点，非必须，默认为图片的左上角
     * @param startY                          二维码Y轴起点，非必须，默认为图片的左上角
     * @param QRCodeWidth                     二维码的宽度，非必须，默认为背景图最小边
     * @param isDeformation                   是否把背景图变成方形，非必须，默认不改变图片形状
     * @param fillPositionDetectionShapeModel 二维码四个大码眼的形状，目前只支持方形和圆方形
     * @param fillShapeModel                  二维码点的形状，目前只支持方形和圆形
     * @throws IOException
     */
