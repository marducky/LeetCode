//����
package majors.openSource.TetrisPlay.java;
...
//				Tetris.class.getResource("tetris_1.png"));
...
//			background = ImageIO.read(Tetris.class.getResource("tetris_1.png"));
//			background = ImageIO.read(Tetris.class.getResource("majors/openSource/TetrisPlay/img/tetris_1.png"));
//			background = ImageIO.read(new File(project+"src/majors/openSource/TetrisPlay/img/tetris_1.png"));
            background = ImageIO.read(new File(project + "/src/majors/openSource/TetrisPlay/img/tetris.png"));
...
//			O=ImageIO.read(Tetris.class.getResource("O.png"));
            T = ImageIO.read(new File(project + "/src/majors/openSource/TetrisPlay/img/T.png"));
            I = ImageIO.read(new File(project + "/src/majors/openSource/TetrisPlay/img/I.png"));
            S = ImageIO.read(new File(project + "/src/majors/openSource/TetrisPlay/img/S.png"));
            Z = ImageIO.read(new File(project + "/src/majors/openSource/TetrisPlay/img/Z.png"));
            L = ImageIO.read(new File(project + "/src/majors/openSource/TetrisPlay/img/L.png"));
            J = ImageIO.read(new File(project + "/src/majors/openSource/TetrisPlay/img/J.png"));
            O = ImageIO.read(new File(project + "/src/majors/openSource/TetrisPlay/img/O.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
