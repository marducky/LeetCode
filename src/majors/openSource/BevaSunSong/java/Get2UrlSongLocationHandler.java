 ...
 * @date: 2018/02/26 14:57
 **/
public class Get2UrlSongLocationHandler {
    private String url;

    public Get2UrlSongLocationHandler(String url) {
        this.url = url;
    }
    ...
    private JSONObject getJsonList(String url) {
        ...
        try {
            ...
            connection.setRequestProperty("Referer", "http://g.beva.com/kan-erge/c10106--xiao-zhi-zhu-zhi-da-wang.html");
